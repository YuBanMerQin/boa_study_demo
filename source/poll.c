...
//		if (pfd_len)
//		{
//			timeout = (request_ready ? 0 : (request_block ? default_timeout : -1));
//
...
//			{
//				/*  */
//				if (pfds[server_pfd].revents & (POLLNVAL | POLLERR))
//				{
//					/* problem with the server socket, unexpected */
//					log_error("server pfd revent contains POLLNVAL or POLLERR! Exiting.");
//					exit(EXIT_FAILURE);
//				}
